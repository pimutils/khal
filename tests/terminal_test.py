...
def test_colored():
    ...
    assert (
        colored("täst", "light magenta", "dark green", True)
        == "\x1b[1;35m\x1b[42mtäst\x1b[0m"
    )
    assert (
        colored("täst", "light magenta", "dark green", False)
        == "\x1b[95m\x1b[42mtäst\x1b[0m"
    )
    assert (
        colored("täst", "light magenta", "light green", True)
        == "\x1b[1;35m\x1b[42mtäst\x1b[0m"
    )
    assert (
        colored("täst", "light magenta", "light green", False)
        == "\x1b[95m\x1b[102mtäst\x1b[0m"
    )
    assert colored("täst", "5", "20") == "\x1b[38;5;5m\x1b[48;5;20mtäst\x1b[0m"
    assert (
        colored("täst", "#F0F", "#00AABB")
