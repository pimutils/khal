        ...
        for key, comment in sorted(spec[secname].comments.items()):
            if key == "__many__":
                ...
                for key, comment in sorted(spec[secname]["__many__"].comments.items()):
                    write_section(spec[secname]["__many__"][key], secname, key, comment, f)
            else:
...
project = "khal"
copyright = "Copyright (c) 2013-2022 khal contributors"
...
man_pages = [("man", "khal", "khal Documentation", ["Christan Geier et al."], 1)]
...
texinfo_documents = [
    (
        ...
        "khal contributors",
        "khal",
        "A standards based calendar program",
        "Miscellaneous",
    ),
]
