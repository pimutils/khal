...
def test_raw_dt():
    ...
    assert (
        event.format(LIST_FORMAT, dt.date(2014, 4, 9)) == "09:30-10:30 An Event\x1b[0m"
    )
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 9))
...
def test_update_simple():
    ...
    event_updated = Event.fromString(
        _get_text("event_dt_simple_updated"), **EVENT_KWARGS
    )
...
def test_no_end():
    ...
    # usually do
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 12))
...
def test_raw_d():
    ...
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 9)) == "09.04.2014 An Event\x1b[0m"
    )
...
def test_update_event_d():
    ...
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 20))
...
def test_dt_two_tz():
    ...
    assert (
        event.format(LIST_FORMAT, dt.date(2014, 4, 9)) == "09:30-16:30 An Event\x1b[0m"
    )
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 9))
...
def test_event_dt_rr():
    ...
    assert (
        event.format(LIST_FORMAT, dt.date(2014, 4, 9))
        == "09:30-10:30 An Event ⟳\x1b[0m"
    )
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 9))
        == "09.04.2014 09:30-10:30 An Event ⟳\x1b[0m"
    ...
    assert (
        event.format("{repeat-pattern}", dt.date(2014, 4, 9))
...
def test_event_d_rr():
    ...
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 10))
...
def test_event_d_long():
    ...
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 4, 16))
...
def test_event_no_dst(pytz_version):
    ...
    if pytz_version > (2017, 1):
        cal_no_dst = cal_no_dst.replace(
            "TZNAME:COT", "RDATE:20380118T221407\r\nTZNAME:-05"
        )
...
def test_cancelled_instance():
    ...
    assert (
        event.format(SEARCH_FORMAT, dt.date(2014, 7, 14))
...
def test_duplicate_event():
    ...
    assert (
        dupe._vevents["PROTO"]["UID"].to_ical()
...
def test_format_colors():
    ...
    assert (
        event.format(format_, dt.date(2014, 4, 9)) == "\x1b[31mAn Event\x1b[0m\x1b[0m"
    )
