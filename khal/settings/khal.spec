...
# Defines a color theme for khal.
# The two currently available color schemes are *dark* and *light*
# This is very much work in progress. Help is really welcome!  
# The themes are defined in *khal/ui/colors.py*,
# you can either help improve those or create a new one (see below). 
# As ikhal uses urwid, have a look at `urwid's documentation`__
