...
def test_raw_dt():
    ...
    assert event.format(SEARCH_FORMAT, date(2014, 4, 9)) == '09.04.2014 09:30-10:30 An Event \x1b[0m'
...
def test_dt_two_tz():
    ...
    assert event.format(SEARCH_FORMAT, date(2014, 4, 9)) == '09.04.2014 09:30-16:30 An Event \x1b[0m'
